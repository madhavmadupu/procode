...
- [ ] IPC layer — typed tRPC adapter for FS operations
...
### State Management
- [ ] Zustand stores — workspace, editor, tabs, file tree
- [ ] IPC wiring — connect renderer stores to main process services
...
- [ ] EmbeddingProvider — ALWAYS Ollama, `nomic-embed-text`, decoupled from chat
...
### RAG Pipeline
- [ ] Code-aware chunking — function-level, class-level, file-level
